    ...
    return {
      ...
      prijzen: {
        consument: vindPrijs(f,
          ...
          "prijs","price"),
        zzp: vindPrijs(f,
          "prijs-zzp","prijs-instructeur","prijs-zelfstandige",
          "price-zzp","price-instructor","prijs-excl-btw",
          "prijs-netto","prijs-excl","prijs","price"),
        bedrijf: vindPrijs(f,
...
const FALLBACK = {
  ...
  beschikbaar: { tijdsloten:["08:00","10:00","13:00","15:00"], weekdagen:[1,3,5], geblokkeerdeData:[] },
