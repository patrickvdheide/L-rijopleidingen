...
-- Volledig schema inclusief alle kolommen
-- Veilig op bestaande en nieuwe databases (IF NOT EXISTS + IF NOT COLUMN)
...
CREATE TABLE IF NOT EXISTS boekingen (
  ...
  bedrijfsnaam      TEXT,
  kvk               TEXT,
  opleidingsnummer  TEXT,
  cursisten_json    TEXT,
  aantal_cursisten  INTEGER NOT NULL DEFAULT 1,
